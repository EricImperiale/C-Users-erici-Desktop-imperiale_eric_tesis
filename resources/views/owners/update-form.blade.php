...
@section('main')
    <h2 class="fs-1">
        <span class="text-muted">Editar un Propietario: </span> {{ $owner->name }} {{ $owner->surname }}, DNI {{ $owner->id }}
    </h2>
    <span class="d-block text-muted mb-3">* Campos Obligatios</span>

    <form
        action="{{ route('owners.processUpdate', ['owner_id' => $owner->owner_id]) }}"
        method="post"
    >
        @csrf
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        value="{{ old('id') ?? str_replace('.', '', $owner->id) }}"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        value="{{ old('tin') ?? str_replace('-', '', $owner->tin) }}"
            ...
            <div class="row">
                    ...
                    >
                        ...
                        @foreach($countryPhoneCodes as $countryPhoneCode)
                            <option
                                ...
                                @selected(old('country_phone_code_id', $owner->country_phone_code_id) == $countryPhoneCode->country_phone_code_id)
                            >
                ...
                <div class="col-md-2">
                    ...
                    <input
                        ...
                        value="{{ old('area_code') ?? $owner->area_code }}"
                        placeholder="011"
                        maxlength="4"
                    >
                ...
                <div class="col-md-8">
                    ...
                    <input
                        ...
                        value="{{ old('mobile_phone') ?? $owner->mobile_phone }}"
