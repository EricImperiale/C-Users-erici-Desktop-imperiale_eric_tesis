...
@section('main')
    <h2 class="fs-1">
        <span class="text-muted">Editar un Garante: </span> {{ $guarantor->name }} {{ $guarantor->surname }}, DNI {{ $guarantor->id }}
    </h2>
    <span class="d-block text-muted mb-3">* Campos Obligatios</span>

    <form
        action="{{ route('guarantors.processUpdate', ['guarantor_id' => $guarantor->guarantor_id]) }}"
        method="post"
    >
        @csrf
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        value="{{ old('id') ?? str_replace('.', '', $guarantor->id) }}"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        value="{{ old('tin') ?? str_replace('-', '', $guarantor->tin) }}"
        ...
        <div class="mb-3">
            <div>
                ...
                <input
                    ...
                    value="{{ old('date_of_birth') ?? $guarantor->date_of_birth }}"
                >
            ...
            <div class="row">
                    ...
                    >
                        ...
                        @foreach($countryPhoneCodes as $countryPhoneCode)
                            <option
                                ...
                                @selected(old('country_phone_code_id', $guarantor->country_phone_code_id) == $countryPhoneCode->country_phone_code_id)
                            >
                ...
                <div class="col-md-2">
                    ...
                    <input
                        ...
                        value="{{ old('area_code') ?? $guarantor->area_code }}"
                        placeholder="011"
                        maxlength="4"
                    >
                ...
                <div class="col-md-8">
                    ...
                    <input
                        ...
                        value="{{ old('mobile_phone') ?? $guarantor->mobile_phone }}"
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-4">
                    ...
                    <input
                        ...
                        value="{{ old('country') ?? $guarantor->country }}"
                    >
                ...
                <div class="col-md-4">
                    ...
                    <input
                        ...
                        value="{{ old('zip_code') ?? $guarantor->zip_code }}"
                        placeholder="1101"
                    >
        ...
        <div class="mt-4 mb-3">
            <button type="submit" class="btn btn-primary">Editar Garante</button>
        </div>
    </form>
@endsection
