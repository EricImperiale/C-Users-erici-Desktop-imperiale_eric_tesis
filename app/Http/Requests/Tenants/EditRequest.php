...
class EditRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'id.unique' => 'Ya existe un inquilino con ese DNI.',
            ...
            'email.unique' => 'Ya existe un inquilino con ese email.',
            ...
            'mobile_phone.unique' => 'Ya existe un inquilino con ese número de teléfono.',
