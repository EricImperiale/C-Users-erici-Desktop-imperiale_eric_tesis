...
class CreateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            'name' => 'required',
            'surname' => 'required',
            'id' => 'required|numeric|min_digits:8|max_digits:8|unique:guarantors,id',
            'tin' => ['required', 'numeric', 'min_digits:11', 'max_digits:11', 'unique:owners,tin', new ValidateDniTinMatch],
    ...
    public function messages(): array
    {
        return [
            ...
            'id.unique' => 'Ya existe un propietario con ese DNI.',
            ...
            'tin.unique' => 'Ya existe un garante con ese CUIT o CUIL.',
            ...
            'email.unique' => 'Ya existe un garante con ese email.',
            ...
            'mobile_phone.unique' => 'Ya existe un garante con ese número de teléfono.',
            ...
            //'comments.max_digits' => 'El campo comentarios no debe tener más de :max caracteres.',
        ];
    }
}
